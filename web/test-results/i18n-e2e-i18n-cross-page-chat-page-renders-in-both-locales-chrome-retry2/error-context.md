...
- Name: i18n-e2e.spec.js >> i18n cross-page >> chat page renders in both locales
- Location: e2e/journeys/i18n-e2e.spec.js:38:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8080/en/chat.html
Call log:
  - navigating to "http://localhost:8080/en/chat.html", waiting until "load"
