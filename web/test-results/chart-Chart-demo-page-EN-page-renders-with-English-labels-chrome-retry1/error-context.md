...
- Name: chart.spec.js >> Chart demo page >> EN page renders with English labels
- Location: e2e/journeys/chart.spec.js:55:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8080/en/chart.html
Call log:
  - navigating to "http://localhost:8080/en/chart.html", waiting until "load"
...
```ts
  1   | // Chart demo page tests — validates static BaZi demo report rendering, i18n, print/share.
  2   | // Source: chart.html, demo-utils.js, i18n.js.
  3   | 
