...
- Name: report.spec.js >> Report page >> paid bond report renders bond-specific data
- Location: e2e/journeys/report.spec.js:205:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8080/zh/report/cafe-fade
Call log:
  - navigating to "http://localhost:8080/zh/report/cafe-fade", waiting until "load"
