...
- Name: report.spec.js >> Report page >> paid chart report in EN locale
- Location: e2e/journeys/report.spec.js:192:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8080/en/report/beef-dead
Call log:
  - navigating to "http://localhost:8080/en/report/beef-dead", waiting until "load"
