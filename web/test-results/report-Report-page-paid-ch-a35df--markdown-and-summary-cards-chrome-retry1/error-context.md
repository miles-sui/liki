...
- Name: report.spec.js >> Report page >> paid chart report renders markdown and summary cards
- Location: e2e/journeys/report.spec.js:167:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8080/zh/report/dead-beef
Call log:
  - navigating to "http://localhost:8080/zh/report/dead-beef", waiting until "load"
