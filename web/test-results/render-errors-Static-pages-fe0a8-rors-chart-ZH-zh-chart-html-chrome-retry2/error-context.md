...
- Name: render-errors.spec.js >> Static pages — no render errors >> chart ZH: /zh/chart.html
...
Call log:
  - navigating to "http://localhost:8080/zh/chart.html", waiting until "domcontentloaded"
