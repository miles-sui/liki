...
- Name: i18n-e2e.spec.js >> i18n cross-page >> setLang stores preference and redirects, persists across navigation (i18n.js:27-31)
- Location: e2e/journeys/i18n-e2e.spec.js:17:3
