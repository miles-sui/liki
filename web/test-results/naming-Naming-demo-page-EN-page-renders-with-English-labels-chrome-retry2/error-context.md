...
- Name: naming.spec.js >> Naming demo page >> EN page renders with English labels
- Location: e2e/journeys/naming.spec.js:37:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8080/en/naming.html
Call log:
  - navigating to "http://localhost:8080/en/naming.html", waiting until "load"
