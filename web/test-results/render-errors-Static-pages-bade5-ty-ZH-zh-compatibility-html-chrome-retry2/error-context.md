...
- Name: render-errors.spec.js >> Static pages — no render errors >> compatibility ZH: /zh/compatibility.html
...
Call log:
  - navigating to "http://localhost:8080/zh/compatibility.html", waiting until "domcontentloaded"
