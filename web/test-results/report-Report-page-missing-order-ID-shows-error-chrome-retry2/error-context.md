...
- Name: report.spec.js >> Report page >> missing order ID shows error
- Location: e2e/journeys/report.spec.js:133:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8080/en/report/
Call log:
  - navigating to "http://localhost:8080/en/report/", waiting until "load"
...
```ts
  34  | ## 第三章 · 十神解读
  35  | 
  36  | 年柱甲子，甲为七杀，子为正财。月柱丙寅，丙为偏印，寅为七杀。
  37  | 
  38  | ## 第四章 · 大运流年
  39  | 
  40  | 当前大运戊辰，比肩帮身，财运亨通。
