...
- Name: smoke.spec.js >> Smoke — all pages render without errors or warnings >> compatibility (vanilla): /zh/compatibility.html
- Location: e2e/journeys/smoke.spec.js:72:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8080/zh/compatibility.html
Call log:
  - navigating to "http://localhost:8080/zh/compatibility.html", waiting until "load"
