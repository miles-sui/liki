...
- Name: report.spec.js >> Report page >> save banner visible by default, has copy link and close buttons
- Location: e2e/journeys/report.spec.js:152:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8080/en/report/abba
Call log:
  - navigating to "http://localhost:8080/en/report/abba", waiting until "load"
