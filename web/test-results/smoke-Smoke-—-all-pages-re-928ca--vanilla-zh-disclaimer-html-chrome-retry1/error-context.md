...
- Name: smoke.spec.js >> Smoke — all pages render without errors or warnings >> disclaimer (vanilla): /zh/disclaimer.html
- Location: e2e/journeys/smoke.spec.js:72:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8080/zh/disclaimer.html
Call log:
  - navigating to "http://localhost:8080/zh/disclaimer.html", waiting until "load"
