...
- Name: render-errors.spec.js >> Static pages — no render errors >> terms ZH: /zh/terms.html
- Location: e2e/journeys/render-errors.spec.js:45:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8080/zh/terms.html
Call log:
  - navigating to "http://localhost:8080/zh/terms.html", waiting until "domcontentloaded"
